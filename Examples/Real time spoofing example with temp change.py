    ...
    if (UTCTimeMicroseconds < 50000) and (UTCTime >= TxPreparationUTCTime2) and (Tx2State > 0):
        ...
        if Tx2FrameNumber == 0:
            ...
            if RSRecovered2:
                ...
                # Change the ambient temperature value
                Tx2AmbTemp = Tx2AmbTemp + 2 * math.sin( 2*math.pi * 
                                    ( Tx2FrameNumber - RefFrameNumber1 ) / FramesToBeTransmitted )
                # Change the ambient pressure value
                Tx2AmbPress = Tx2AmbPress + 5 * math.cos( 2*math.pi * 
                                    ( Tx2FrameNumber - RefFrameNumber1 ) / FramesToBeTransmitted )
